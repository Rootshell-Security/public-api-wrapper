...
class PhasesAPIClient(BaseAPIClient):
    def __init__(self):
        super().__init__(base_url=f"{API_ENDPOINT}/phases")
    ...
    def create_entity(self, entity: PhaseDTO) -> Union[Dict, str]:
        data = entity.to_dict()
    ...
    def update_entity(self, entity_id: int, entity: PhaseDTO) -> Union[Dict, str]:
        data = entity.to_dict()
