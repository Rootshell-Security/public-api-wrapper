...
class PhaseHostsAPIClient(BaseAPIClient):
    def __init__(self, phaseId):
        super().__init__(base_url=f"{API_ENDPOINT}/phases/{phaseId}/hosts")
    ...
    def create_entity(self, entity: PhaseHostDTO) -> Union[Dict, str]:
        data = entity.to_dict()
    ...
    def update_entity(self, entity_id: int, entity: PhaseHostDTO) -> Union[Dict, str]:
        data = entity.to_dict()
