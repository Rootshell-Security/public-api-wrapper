...
class PhaseIssuesAPIClient(BaseAPIClient):
    def __init__(self, phaseId):
        super().__init__(base_url=f"{API_ENDPOINT}/phases/{phaseId}/issues")
    ...
    def create_entity(self, entity: PhaseIssueDTO) -> Union[Dict, str]:
        data = entity.to_dict()
    ...
    def update_entity(self, entity_id: int, entity: PhaseIssueDTO) -> Union[Dict, str]:
        data = entity.to_dict()
